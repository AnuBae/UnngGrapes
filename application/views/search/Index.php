                    ...
                    <div class="col-md-12 col-lg-12 mb-5">
                        <div class="portfolio-item mx-auto">
                            <table class="table text-center" id="lowongan" style="width:100%">
                                <thead>
                                    <h3 class="masthead-subheading text-center font-weight-bold mb-3">List Lowongan</h3>
                                ...
                                <tbody>
                                    <?php $start = 0; foreach($lowongan as $lwng) : ?>
                    ...
                    <div class="col-md-12 col-lg-12 mb-5">
                        <div class="portfolio-item mx-auto">
                            <table class="table text-center" id="table_tf"  style="width:100%">
                                ...
                                <tbody>
                                    <?php $j = 0; foreach($nilai_tf as $dataTf) : ?>
                    ...
                    <div class="col-md-12 col-lg-12 mb-5">
                        <div class="portfolio-item mx-auto">
                            <table class="table text-center" style="width:100%">
                                ...
                                <tbody>
                                    <?php $j = 0; foreach($nilai_idf as $dataIdf) : ?>
                                        <tr>
                                            <th><?= ++$j; ?></th>
                                            <th><?= $dataIdf['term']; ?></th>
                                            <th><?= $dataIdf['df']; ?></th>
                    ...
                    <div class="col-md-12 col-lg-12 mb-5">
                        <div class="portfolio-item mx-auto">
                            <table class="table text-center" id="table_tfidf" style="width:100%">
                                ...
                                <tbody>
                                    <?php $j = 0; foreach($nilai_tfidf as $dataTfidf) : ?>
